...
t_tv =1e-1; 
t_htv = 1e-1; %< .01, small steps for second Der. 
E1iter = 100; 
E2iter = 1000; 
...
for i = 1:E2iter
    ...
    dxy = ui1j1 - uij1 -ui1j+v;
    dxy_ = ui_j_-uij_-ui_j+v; 

    dyx = ui1j1-ui1j-uij1+v;
    dyx_=ui_j_-ui_j-uij_+v; 
